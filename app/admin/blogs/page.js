...
//           <div>
//             <h1 className="text-4xl font-extrabold text-blue-800 mb-1 tracking-tight">Manage Blogs</h1>
...
//                       </td>
//                       <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
//                         {blog.createdBy ? blog.createdBy : 'Admin'}
//                       </td>
    ...
    <AdminLayout>
      <div className="space-y-8 min-h-screen py-8 px-2 sm:px-0">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-2">
          ...
          <Link
            href="/admin/blogs/add"
            className="bg-blue-600 text-white px-5 py-2 rounded-lg flex items-center gap-2 hover:bg-blue-700 shadow w-fit"
          >
            <Plus size={20} />
            Add Blog
          </Link>
        ...
        {loading ? (
          ...
          <>
            {/* Desktop Table */}
            <div className="hidden lg:block bg-white shadow-md rounded-xl overflow-hidden">
              <div className="overflow-x-auto">
                <table className="min-w-full divide-y divide-gray-200">
                  <thead className="bg-blue-50 sticky top-0 z-10">
                    <tr>
                      <th className="px-6 py-3 text-left text-xs font-bold text-blue-700 uppercase tracking-wider w-2/5">
                        Title
                      </th>
                      <th className="px-6 py-3 text-center text-xs font-bold text-blue-700 uppercase tracking-wider w-20">
                        Status
                      </th>
                      <th className="px-6 py-3 text-center text-xs font-bold text-blue-700 uppercase tracking-wider w-20">
                        Views
                      ...
                      <th className="px-6 py-3 text-center text-xs font-bold text-blue-700 uppercase tracking-wider w-32">
                        Actions
                      </th>
                    </tr>
                  </thead>
