...
//         'print', 'about'
//       ],
//       removeButtons: ['source'], // Remove source code button if you don't want it
...
//       },
//       uploader: {
//         insertImageAsBase64URI: true, // Convert images to base64
//         // You can configure file upload settings here
...
//       filebrowser: {
//         ajax: {
//           // url: '/api/filebrowser' // Your file browser endpoint
//         }
//       }
//     }),
//     []
...
//   return (
//     <form onSubmit={handleSubmit} className="space-y-8 bg-white p-4 sm:p-8 rounded-2xl shadow-2xl max-w-full mb-10 mx-auto border border-blue-50" style={{ fontFamily: 'Inter, Nunito Sans, Lato, sans-serif' }}>
//       {/* title */}
//       <div>
...
//             config={config}
//             onBlur={handleContent} // Use onBlur for better performance
//             onChange={() => {}} // Keep empty to avoid performance issues
//           />
//         </div>
//       </div>
